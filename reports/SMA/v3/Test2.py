...
sheet_data = gSheetService.get_data("1roOZQvWo4g_M6uZj6t-3jriELM_pmkizt7b4k9Ni2VQ", "A1:L")
rslt_df = sheet_data[(sheet_data['Real_Sold_Date']=="") | (sheet_data['Real_Sold_Date'].isnull())]
buy_list = rslt_df.Ticker.values.tolist()
