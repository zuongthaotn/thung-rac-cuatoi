...
def prepareData(htd):
    ...
    htd['RSI_trend'] = htd['RSI_20'].round(2)
...
k = prepared_data[["pass_2_return", "pass_1_return", "today_return", "EMA_H", "RSI_trend", "Next_Low_Is_Lower"]]
...
# xxx.to_csv(str(current_folder)+'/VN30F2312.csv')
