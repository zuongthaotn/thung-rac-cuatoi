...
if __name__ == "__main__":
    ...
    # df = df[(df["MA5-MA20"] != df["MA5-MA20_yesterday"]) | (df["MA5-MA20_yesterday"] != df["MA5-MA20_2_days_ago"])]

    # split dataset in features and target variable
    # feature_cols = ["short_trend", "Today_Up_Down", "MA5-MA20", "MA5-MA20_yesterday", "MA5-MA20_2_days_ago",
    #                 "Body_Candlestick_Rate", "RSI_10_Simple", "Next_Open_Is_Lower"]
    ...
    y = df.Next_Up_Down  # Target variable
    ...
    # trainner_file = str(current_folder) + '/GradientBoostingClassifier_next_close.pickle'
    ...
    #
    # algo_result.to_csv(str(current_folder) + '/next_close_predict_result.csv')
